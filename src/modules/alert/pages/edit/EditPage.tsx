...
export default function EditAlertRulePage() {
  ...
  const alertRuleEditSchema = form({
    name: field.text({
    ...
    title: translate("alert.edit.title", "Edit Alert Rule"),
    description: translate(
      "alert.edit.subtitle",
      "Update when and how you want to be notified about detections",
    ),
    submitLabel: translate("alert.edit.submit", "Update Alert Rule"),
  });
  ...
  const record = query?.data?.data as AlertRule | undefined;

  return (
    <div className="w-full max-w-2xl p-6 space-y-6">
      <DynamicForm
        schema={alertRuleEditSchema}
