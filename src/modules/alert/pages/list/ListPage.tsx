...
import { AlertTriangle, Bell, CheckCircle2, Plus, Slash } from "lucide-react";
    ...
    <div className="space-y-6">
      ...
      <StatsOverview
        items={[
          ...
          {
            label: translate("alert.summary.critical_alerts", "Critical Alerts"),
      ...
      <div className="space-y-4">
        {rules.map((rule) => (
          <Card
            key={rule.id}
            className="border-destructive/40 bg-destructive/5 flex flex-col gap-4 rounded-xl border px-4 py-4 sm:px-6"
          >
              ...
              <div className="flex items-start gap-3">
                ...
                <div className="space-y-1">
                  ...
                  <p className="text-xs text-muted-foreground sm:text-sm">
                    {translate("alert.card.subtitle", "Detection rule")}
                    {" • "}
                    {`${translate(
